...
<head>
	...
	<title>{{ get_section_content('project', 'app_name') }} | Administrator Login</title>
	...
	<div class="middle-box text-center loginscreen animated fadeInDown">
		<div>
			<div class="col-lg-12 text-center mb-4" style="margin-top: 70px;">
				<img class="img-responsive" src="{{ asset('images/logo.png') }}" alt="logo" style="width: 241px;">
			</div>
			...
			<p class="m-t"> <strong>Copyright</strong> {{ get_section_content('project', 'app_name') }} &copy; {{ date("Y") }} </p>
			<p class="m-t">Developed by - <a href="https://bzbeetech.com" target="_blank">Busy Bee Technologies </a></p>
		</div>
	</div>
