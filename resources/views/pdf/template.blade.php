...
<body>
  <div class="page-break">
    <div class="outer_container">
      ...
      <hr>
      <p style="text-align: center;margin: 5px 0; font-size: 14px;">Your actual rate, payment, and cost could be higher. Get an official Loan Estimate before choosing a loan.</p>
      <div class="container">
        <div style="width: 100%;">
          <table border="0" style="width: 100%;border: none;margin: 0;">
            ...
            <tbody>
              <tr>
                ...
                <td style="width: 50%; text-align: right;">Preparation Date: {{$date}}</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <table style="border:none;width: 100%;margin:0;height:contents" class="no-page-break">
        <tr style=" ">
          <td style="width: 50%;">
            <!-- First Column -->
            <div class="column">
              ...
              <table>
                <thead>
                  <tr>
                    ...
                    <th style="text-align:right;">$ {{convertToMoney($total_loan_cost_table_d)}}</th>
                  </tr>
                </thead>
                <tbody>
                </tbody>
              ...
              <table>
                ...
                <tbody>
                  ...
                  @if($show_down_payment == true)
                  <tr>
                    <td>Down Payment</td>
                    <td>$ {{convertToMoney($down_payment)}}</td>
                  </tr>
                  @endif
                  <tr>
                  ...
                  @endif
                  @if($show_seller_assistance == true)
                  <tr>
                    <td>Sellers Assistance</td>
                    <td>$ {{convertToMoney($seller_assistance)}}</td>
                  </tr>
                  @endif
                  <tr>
                    <td>Loan Amount</td>
                  ...
                  <thead>
                    <tr>
                      <th>Total Estimated Funds To You</th>
      ...
      <div>
        ...
        <p style="margin: 0;color:#4d4d4d; font-size:12px;">Disclaimers</p>
        <p style="margin-top: 3px;font-size:12px;">Information provided above reflects estimates of the charges that are likely to be incurred at the closing of this loan. Actual charges may be more or less. Before closing, your interest rate, points, and lender credits can change unless you lock the interest rate.</p>
        <table style="border: none;width:100%;">
          <tr>
            <td style=" width: 100px; height: 30px;">
              <img src="{{ public_path('/images/pdflogo.png') }}" style="height: 45px; width: 150px;" alt="" srcset="">
            </td>
            <td style="width: 280px; text-align: left; padding-left:15px;">
              <h3 style="text-align:start;margin:0;margin-bottom:4px; font-size:12px;">West Capital Lending</h3>
              <p style="text-align:start;font-size:12px; ">24 Executive Park Suit 250, Irvine, CA92614 Company NMLS: 1566096 </p>
            </td>
            <td style="width: 50%; text-align: right;"><img src="{{ public_path('/images/equal.jpg') }}" alt="" srcset="" style="height: 50px;width: 50px;margin-left:auto"></td>
          </tr>
        </table>
      </div>
    </div>
